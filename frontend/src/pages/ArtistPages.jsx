...
//                     <h4 className="text-sm font-semibold text-gray-600 mb-1">Images</h4>
//                     <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
//                       {artist.media.filter((item) => item.type === "image").map((image, i) => (
//                         <img
//                           key={i}
//                           src={image.url}
//                           alt={`media-${i}`}
...
//                           <span
//                             key={i}
//                             className="bg-rose-100 text-purple-700 px-3 py-1 rounded-full text-sm font-medium"
//                           >
//                             {s}
//                           </span>
//                         ))}
...
//                 <p className="text-gray-700 text-sm">{artist.location?.city || "N/A"}</p>
//               </div>
...
//               {artist.genres?.length > 0 && (
//                 <div>
//                   <p className="text-sm font-semibold text-purple-700 mb-1">Genres</p>
//                   <div className="flex flex-wrap gap-2">
//                     {artist.genres.map((g, i) => (
//                       <span key={i} className="bg-rose-100 text-purple-800 px-2 py-1 rounded-full text-xs">{g}</span>
//                     ))}
//                   </div>
//                 </div>
//               )}
...
//               {artist.eventTypes?.length > 0 && (
//                 <div>
//                   <p className="text-sm font-semibold text-purple-700 mb-1">Event Types</p>
//                   <div className="flex flex-wrap gap-2">
//                     {artist.eventTypes.map((e, i) => (
//                       <span key={i} className="bg-rose-100 text-purple-800 px-2 py-1 rounded-full text-xs">{e}</span>
//                     ))}
//                   </div>
//                 </div>
//               )}
...
//               {artist.languages?.length > 0 && (
//                 <div>
//                   <p className="text-sm font-semibold text-purple-700 mb-1">Languages</p>
//                   <div className="flex flex-wrap gap-2">
//                     {artist.languages.map((l, i) => (
//                       <span key={i} className="bg-rose-100 text-purple-800 px-2 py-1 rounded-full text-xs">{l}</span>
//                     ))}
//                   </div>
//                 </div>
//               )}
...
//               {/* Schedule */}
//               <div>
//                 <h2 className="text-sm font-semibold text-purple-700 mb-1">📅 Schedule</h2>
//                 <div className="bg-white rounded-xl shadow p-2">
...
//               <h2 className="text-2xl font-bold text-purple-700">Artist Profile</h2>
//               <Link to="/editartist">
//                 <button className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition">Edit Profile</button>
//               </Link>
//             </div>

//             <div className="border-b pb-2 flex gap-6 font-semibold text-purple-700 sticky top-20 bg-white z-10">
//               <button onClick={() => scrollToRef(bioRef)} className={`hover:text-purple-900 ${activeSection === "bio" ? "border-b-2 border-purple-600" : ""}`}>Bio</button>
//               <button onClick={() => scrollToRef(mediaRef)} className={`hover:text-purple-900 ${activeSection === "media" ? "border-b-2 border-purple-600" : ""}`}>Media</button>
//               <button onClick={() => scrollToRef(reviewsRef)} className={`hover:text-purple-900 ${activeSection === "reviews" ? "border-b-2 border-purple-600" : ""}`}>Reviews</button>
//             </div>
...
//               <div ref={bioRef} className="scroll-mt-28">
//                 <h3 className="text-lg font-semibold mb-2 text-purple-700">Bio</h3>
//                 <p className="text-gray-700 text-sm">{artist.bio || "This artist has not written a bio yet."}</p>
//               </div>
...
//                     <h4 className="text-sm font-semibold text-gray-600 mb-1">Videos</h4>
//                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                       {artist.media.filter((item) => item.type === "video").map((video, i) => (
//                         <video key={i} src={video.url} controls className="rounded-xl w-full max-h-60 object-cover shadow-md" />
//                       ))}
//                     </div>
//                   </div>
//                 )}
...
//                     <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
//                       {artist.media.filter((item) => item.type === "image").map((image, i) => (
//                         <img key={i} src={image.url} alt={`media-${i}`} className="rounded-xl w-full h-40 object-cover shadow-md" />
//                       ))}
//                     </div>
//                   </div>
//                 ) : (
