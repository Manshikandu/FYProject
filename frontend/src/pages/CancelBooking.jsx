...
// //       const endpoint =
// //         user.role === "artist"
// //           ? `/artist/bookings/${bookingId}/cancel`
// //           : `/bookings/${bookingId}/cancel`;

// //       const res = await axios.patch(endpoint, { reason: finalReason, notes });
...
// //         className={`w-full bg-red-600 text-white py-2 rounded hover:bg-red-700 transition flex justify-center items-center ${
