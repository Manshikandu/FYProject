...
//           viewBox="0 0 24 24"
//           stroke="#facc15"
//           className={`w-6 h-6 cursor-${readOnly ? "default" : "pointer"} ${!readOnly && "hover:scale-110 transition-transform"}`}
//         >
//           <path
//             strokeLinecap="round"
...
//           <label className="block mb-1 text-left">Rating:</label>
...
//       {submitted && <p className="text-green-500 mt-4">✅ Thank you for your review!</p>}
