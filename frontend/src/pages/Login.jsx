            ...
            <div className='bg-purple-300 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <button
                        ...
                        hover:bg-purple-500 hover:text-white focus:ring-gray focus:border-gray focus:ring-offset-2
                ...
                <p className='mt-8 text-center text-sm text-black'>
                    ...
                    <Link to='/signup-select' className='font-medium text-black hover:text-purple-500'>
