      ...
      <div className="text-center mb-8">
        ...
        {/* {algorithmInfo && (
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-600">
            {getAlgorithmIcon(algorithmInfo.algorithm)}
            <span>
              {algorithmInfo.isNewUser 
                ? 'Trending artists popular with other clients'
                : algorithmInfo.algorithm === 'smart-picks'
                ? `Smart picks based on your ${algorithmInfo.userBookings} bookings`
                : `Curated for you based on ${algorithmInfo.userBookings} previous bookings`
              }
            </span>
          </div>
        )} */}
