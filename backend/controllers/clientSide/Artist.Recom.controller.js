////////chalirako without colaborative matrix
...
//       console.log(`Computed score for artist ${other.username}: ${totalScore}`);
//     }

//     scores.sort((a, b) => b.score - a.score);
//     const topArtists = scores.slice(0, 5).map(s => s.artist);
//     console.log("Recommended artists data:", topArtists.map(a => ({
//   username: a.username,
//   weightedRating: a.weightedRating,
